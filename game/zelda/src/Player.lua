...
function Player:update(dt)
    ...
    if gameState == 'running' then
        ...
        if love.keyboard.wasPressed('lshift') and Sword.timer < 0 and Player.state == 'walking' and Player.slot1 ~= nil then
            Player:attack('sword')
        end

        if love.keyboard.wasPressed('z') and #arrows <= 0 and Player.money > 0 and Player.state == 'walking' and Player.slot2 == 'bow' then
            Player:attack('bow')
        end
